package com.huawei.zkexp.curator.leader;

import com.google.common.collect.Lists;
import com.huawei.zkexp.curator.factory.ClientFactory;
...
public class LeaderLatchExample {
    public static void main (String[] args) {
        ...
        try {
            for (int i = 0; i < 10; i++) {
                CuratorFramework client = ClientFactory.newClient();//工厂方法创建curator client
